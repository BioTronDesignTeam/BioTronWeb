...
func main() {
	...
	addr := ":" + cfg.Port
	events.LogAsync(logclient.Info, "Exo API started", map[string]any{"port": cfg.Port})
	...
	if err := events.Log(shutdownLogCtx, logclient.Info, "Exo API stopping", nil); err != nil {
